...
{
    /**
     * Final comprehensive schema fix for time capsules application
     * This migration ensures all required columns exist and are properly configured
     */
    public function up(): void
    {
        // Fix capsule_artifacts table - ensure all required columns exist
        Schema::table('capsule_artifacts', function (Blueprint $table) {
            // Ensure title column exists (this is the main issue from the error)
            if (!Schema::hasColumn('capsule_artifacts', 'title')) {
                $table->string('title')->nullable()->after('id');
            }
            
            // Ensure content column exists as JSON
            ...
            // Fix foreign key - ensure it uses the correct column name
            if (Schema::hasColumn('capsule_artifacts', 'time_capsule_id')) {
                ...
                // If neither exists, create capsule_id
        ...
        // Ensure time_capsules table has all required columns
        Schema::table('time_capsules', function (Blueprint $table) {
            ...
            // Ensure email_recipients exists
