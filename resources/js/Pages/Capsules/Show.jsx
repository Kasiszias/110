...
export default function Show({ auth, capsule, artifacts }) {
  ...
  // Form + state for editing existing artifact
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">{capsule.title}</h2>}
    >
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
          ...
          {/* Stratified artifact layers with inline edit */}
          <div className="bg-white shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900">
                      ...
                      <div className="p-4 space-y-2">
                        {grouped[yearKey].map((artifact) => {
                          ...
                          const submitEdit = (e) => {
                            e.preventDefault();
                            editForm.put(
                              route('capsules.artifacts.update', [capsule.id, artifact.id]),
                              {
                                ...
                                <form onSubmit={submitEdit} className="min-w-0 flex-1 space-y-2">
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <input
                                      ...
                                      onChange={(e) =>
                                        editForm.setData('layer_z_index', e.target.value)
                                      }
                                      placeholder="Layer"
                                    />
                                    <input
